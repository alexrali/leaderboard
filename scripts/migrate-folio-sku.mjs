...
const { Client } = pg
const PASSWORD =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx3Z2FhbWJxemFrcXZ1dm9hY2VtIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MTQzMjcxNywiZXhwIjoyMDg3MDA4NzE3fQ.q0tAgVCK9LgFzjxmDF0ZwpJdqwtBZwG9-Pg3mZxGKqU"
const CONFIGS = [
  {
...
async function getClient() {
  ...
  for (const cfg of CONFIGS) {
    ...
    try {
      ...
      console.log("  [try]", cfg.label, "=>", e.message)
      try {
        await c.end()
      } catch {}
    }
  ...
  throw new Error(
    "All connection configs failed. Provide DB_PASSWORD=<pw> node scripts/migrate-folio-sku.mjs"
  )
}
